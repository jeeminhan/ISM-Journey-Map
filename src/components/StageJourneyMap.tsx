...
const nodePositions: Record<LifecycleStage, { x: number; y: number }> = {
  ...
  return (
    <section className="rounded-2xl border border-white/10 bg-slate-900/70 p-5 md:p-6">
      ...
      <div className="rounded-xl border border-white/10 bg-slate-950/80 p-4">
        ...
        <div className="relative mx-auto hidden h-[320px] w-full max-w-5xl md:block">
          <svg viewBox="0 0 1000 320" className="h-full w-full" aria-hidden="true">
            <defs>
            ...
            <rect x="0" y="0" width="1000" height="320" fill="url(#ocean-stage)" rx="20" />
